...
def extract_multiple_lines_and_save(inputfilename:str,iterations:int, max_distance:int,min_inliers_allowed:int):
    ...
    absolute_path=os.path.join(folder_script,"./",inputfilename)
    ...
    plt.imsave(file_result,superimposed_image)
...
extract_multiple_lines_and_save("SkeletonTrace/skeleton.png",iterations= 30,max_distance=1, min_inliers_allowed=50)